...
import type { Alert } from "@/lib/alerts/generate";
...
export function AlertsPanelClient({ initialAlerts }: { initialAlerts: Alert[] }) {
    ...
    <div className="space-y-2">
      ...
      {alerts.map((alert) => (
        ...
        >
          ...
          <DismissAlertButton alertId={alert.id} onDismiss={removeAlert} />
        </div>
      ))}
    </div>
  );
